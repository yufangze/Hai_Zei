/*************************************************************************
	> File Name: 11.tree_link.c
	> Author: yufangze
	> Mail: 2224590123@qq.com
	> Created Time: 2018年11月04日 星期日 11时23分10秒
 ************************************************************************/
#include <stdio.h>
#include <stdlib.h>
#define NORMAL 0
...
int clear(Node *root) {
    ...
    root->lchild == NORMAL && clear(root->lchild);
    root->rchild == NORMAL && clear(root->rchild);
    free(root);
    return 0;
}
